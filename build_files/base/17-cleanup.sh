...
# nuclear option
# WARNING: Copr repofile '/etc/yum.repos.d/_copr_ublue-os-akmods.repo' has an old format, fix by re-enabling it $ dnf5 copr enable ublue/os-akmods
...
dnf5 -y copr disable @kdesig/kde-beta
